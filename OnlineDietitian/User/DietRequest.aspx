<%@ Page Title="DietRequest" Language="C#" MasterPageFile="~/User/UserPage.master" AutoEventWireup="true" CodeBehind="DietRequest.aspx.cs" Inherits="OnlineDietitian.User.DietRequest" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="UserContent" runat="server">
    ...
    <h4>Diet Request</h4>
    <p>
        <asp:TextBox ID="content_textbox" CssClass="newContent" runat="server">Write what you like and your expectaions</asp:TextBox>
    </p>

    <div class="form-group row">
        <label class="control-label col-sm-2" for="pwd">Diet Type:</label>
