<%@ Page Title="Edit Diet" Language="C#" MasterPageFile="~/AdminPage/Admin.Master" AutoEventWireup="true" CodeBehind="EditDiet.aspx.cs" Inherits="OnlineDietitian.AdminPage.EditDiet"  ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="bs-callout bs-callout-danger">
        ...
        <div class="form-group row">
            <label for="example-text-input" class="col-xs-2 col-form-label">DietRequestID</label>
            <div class="col-xs-10">
                <label class="custom-file">
                    <asp:TextBox type="search" CssClass="form-control" ID="dietrequestidBox" placeholder="id" runat="server"></asp:TextBox>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-10">
                <asp:TextBox type="search" CssClass="updateContent" ID="contentBox" placeholder="content" runat="server"></asp:TextBox>
